...
const MuhurthamSection = () => (
  ...
  >
    <div style={{ width: '100%', display: 'flex', justifyContent: 'center', marginBottom: '1.5rem' }}>
      <img
        src={process.env.PUBLIC_URL + '/images/ganesh.png'}
        alt="Ganesh"
    ...
    <p className="mt-8 text-center w-full" style={{ color: '#4B2E1E', opacity: 0.9 }}>
      Join us for the auspicious Muhurtham ceremony, a sacred moment marking the beginning of our new journey together.
    </p>
    {/* Custom date/time layout */}
    <div className="flex items-center justify-center my-6">
      <div className="flex-1 border-t mx-2" style={{ borderColor: '#4B2E1E' }} />
      <div className="flex flex-col items-center px-2">
        <div className="text-xs tracking-widest font-semibold mb-1" style={{ color: '#4B2E1E', opacity: 0.8 }}>JANUARY</div>
        <div className="flex items-center">
          <div className="text-sm font-semibold mr-3" style={{ color: '#4B2E1E', opacity: 0.8 }}>SATURDAY</div>
          <div className="text-5xl font-bold mx-2" style={{ color: '#4B2E1E' }}>25</div>
          <div className="text-sm font-semibold ml-3" style={{ color: '#4B2E1E', opacity: 0.8 }}>AT 7AM</div>
        </div>
